"""autogenerated by genpy from hermes_move_arm_action/MoveArmActionResult.msg. Do not edit."""
import sys
...
class MoveArmActionResult(genpy.Message):
  _md5sum = "c1f266ba941a8267ab1ec400ae9f4d49"
  _type = "hermes_move_arm_action/MoveArmActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','hermes_move_arm_action/MoveArmResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = hermes_move_arm_action.msg.MoveArmResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = hermes_move_arm_action.msg.MoveArmResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_i.pack(self.result.return_value.val))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.return_value.val,) = _struct_i.unpack(str[start:end])
      return self
