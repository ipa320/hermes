...
#         
    ...
    ####################### GO PRE SHOE ###############################
    pose.pose.position.x = 0.4175
    pose.pose.position.y = -0.3798
    pose.pose.position.z = 1.3672
    pose.pose.orientation.w = 0.60507
    pose.pose.orientation.x = -0.77467
    pose.pose.orientation.y = 0.17379
    pose.pose.orientation.z = -0.059731
    pose.header.frame_id = robot.get_planning_frame()
    pose.header.stamp = rospy.Time.now()
