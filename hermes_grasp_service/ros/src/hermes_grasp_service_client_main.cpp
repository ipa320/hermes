...
int main(int argc, char **argv)
{
	...
	*/
	...
	bool serviceAvailable = ros::service::waitForService("hermes_grasp_service", 5000);
	...
	while(1)
	{
		std::cout << "Enter hand (1=left, 2=right): ";
		...
		bool success = ros::service::call("hermes_grasp_service", req, res);
